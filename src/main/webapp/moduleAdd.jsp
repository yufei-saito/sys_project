	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="row">
					<div class="col-md-12">
						<form action="${pageContext.request.contextPath}/ModuleAdd.action" method="post" class="form-inline" id="addForm">
							<table class="table table-bordered">
  									<tr>
  										<th><label for="exampleInputUname">*模块名</label></th>
  										<td><input type="text" name="mname"  class="form-control" id="name"></td>
  									</tr>
  									<tr>
  										<th><label for="exampleInputGroup">备注</label></th>
  										<td>
  											<textarea name="mtext" cols="80" rows="5"></textarea>
  										</td>
  									</tr>
  									<tr>
  										<td colspan="2" >
