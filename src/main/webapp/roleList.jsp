	...
	<div id="wrapper">
									...
									<ul class="nav">
										<c:forEach items="${m.sonModules}" var="s">
											<li><a
												...
												<c:if test="${s.sname eq'角色管理'}">class='active'</c:if>>${s.sname}</a></li>
										</c:forEach>
									</ul>
								</div>
							</li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="row">
						<form id="role_search" class="form-inline" method="post" action="${pageContext.request.contextPath}/RoleList.action">
							<input id="pageNumber" type="hidden" name="pageNum" value="1">
							<div class="col-md-4">
								<div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">角色名</span>
									<input type="text" class="form-control" name="rname" id="exampleInputName2"  aria-describedby="sizing-addon1" value="${r_cond.rname}">
								</div>
							</div>	
							<div class="col-md-4">
							...
							<div class="col-md-4">		
								<div class="pull-right">
									<a href="${pageContext.request.contextPath}/roleAdd.jsp">
